...
4. Follow the instructions from the link below to install AWS CLI.
   
   [AWS CLI](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html)
   
5. Configure the AWS CLI to access AWS, using the access keys created in the previous section.
...
8. Build the new image using docker build and Dockerfile.
...
3. Create a YAML file and copy the content from the previous YAML file
